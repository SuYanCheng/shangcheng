...
public class User {
	...
	public Date getTelephone() {
		return telephone;
	}
	public void setTelephone(Date telephone) {
	...
	public User(String uid, String username, String password, String name,
			String email, Date telephone, String bithday, String sex,
	...
	public String toString() {
		return "User [uid=" + uid + ", username=" + username + ", password="
				...
				+ ", telephone=" + telephone + ", bithday=" + bithday
